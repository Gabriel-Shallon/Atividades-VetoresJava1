...
public class Atividade027 {
    ...
    public static void main(String[] args){
        ...
        while (A!=1){ 
         ...
         String [] vetB = new String[vetA.length];

         UIManager.put("OptionPane.yesButtonText","Números aleatórios");
         UIManager.put("OptionPane.noButtonText","Números selecionados");


         int b = JOptionPane.showConfirmDialog(null, "Deseja gerar números aleatórios (de 0 a 20) para o vetor A ou seleciona-los?", "Escolher.Vetor", JOptionPane.YES_NO_OPTION);
